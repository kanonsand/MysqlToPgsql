...
public class TableMapping {
     ...
     */
    public TypeCategory[] getParameterTypeCategories(List<String> mysqlColumnNames) {
        ...
        TypeCategory[] categories = new TypeCategory[columns.size()];
        for (int i = 0; i < columns.size(); i++) {
            ...
            if (pgCol != null) {
                ...
                categories[i] = TypeCategory.OTHER;
            }
        }
        return categories;
    }
